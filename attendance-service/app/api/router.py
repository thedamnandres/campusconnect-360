...
from app.auth import get_current_user, require_role, create_access_token, DEMO_USERS, bearer_scheme
...
async def register_attendance(
    ...
    return await attendance_service.register_attendance(db, body)
...
async def report_incident(
    ...
    return await attendance_service.report_incident(db, body)
