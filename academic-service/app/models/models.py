from sqlalchemy import Column, String, DateTime, Enum, ForeignKey, Text, Boolean, Integer, JSON
...
class OutboxEvent(Base):
    """Evento persistido junto con el cambio de negocio antes de publicarse."""
